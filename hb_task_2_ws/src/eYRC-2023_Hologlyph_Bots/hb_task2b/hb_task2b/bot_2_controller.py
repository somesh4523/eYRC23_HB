...
class HBController(Node):
    def __init__(self):
        ...
        #   /hb_bot_2/left_wheel_force,
        #   /hb_bot_2/right_wheel_force,
        #   /hb_bot_2/left_wheel_force
    ...
    def goalCallBack(self, msg):
        self.bot_2_x = msg.x
        self.bot_2_y = msg.y
        self.bot_2_theta = np.radians(msg.theta)
...
def main(args=None):
    ...
    while x_goal1 == 0.0:
        ...
        x_goal1 = hb_controller.bot_2_x
        y_Goal1 = hb_controller.bot_2_y
        theta1 = hb_controller.bot_2_theta
